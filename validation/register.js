...
module.exports = function validateRegisterInput(data) {
  ...
  data.telnumber = !isEmpty(data.telnumber) ? data.telnumber : "";
  ...
  if (Validator.isEmpty(data.telnumber)) {
    errors.telnumber = "Telephone number field is required";
  }
  if (Validator.isEmpty(data.fulladdress)) {
    errors.fulladdress = "Full address field is required";
  }
